package ru.javawebinar.topjava.util.sqlformatter;
...
public class SimpleFormatter implements MessageFormattingStrategy {
    ...
    public String formatMessage(int connectionId, String now, long elapsed, String category, String prepared, String sql) {
        ...
        return String.format("Hibernate With Param: %s %s {elapsed: %dms}", batch, HIBERNATE_SQL_FORMATTER.format(sql), elapsed);
    }
}