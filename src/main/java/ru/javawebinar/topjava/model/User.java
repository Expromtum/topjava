...
@NamedQueries({
        ...
        @NamedQuery(name = User.GET_WITH_MEAL, query = "SELECT u FROM User u " +
                "LEFT JOIN FETCH u.roles LEFT JOIN FETCH u.meals m WHERE u.id=:id ORDER BY m.dateTime DESC"),
})
@Entity
...
public class User extends AbstractNamedEntity {
    ...
    public static final String GET_WITH_MEAL = "User.getWithMeals";
